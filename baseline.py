...
learning_rate = 4e-5  # 模型学习率
num_epochs = 8  # 训练最大迭代次数
...
train_input = './data/enforce_data/'  # 完成预处理的训练集载入路径
...
# 保存概率文件
np.savetxt('./submit/train_prob/train_ernie_' + file_name + '.txt', oof_train)
np.savetxt('./submit/test_prob/test_ernie_' + file_name + '.txt', oof_test)
